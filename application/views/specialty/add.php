			...
			<div class="col-md-12">
				...
				<div class=" ">
					...
					<div style="padding:20px;">
						<form id="defaultForm" method="post" class="form-horizontal" action="<?php echo base_url('specialty/addpost'); ?>">
							 ...
							 <table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									<tr id='addr0'>
										...
										<div class="">
											<input type="text" class="form-control" name="s_name[]" placeholder="Enter Specialty name" />
											</div>
										</div>
...
<!-- /.row -->
 ...
 <script type="text/javascript">
     ...
     $("#add_row").click(function(){
      $('#addr'+i).html("<td>"+ (i+1) +"</td><td><div class='form-group col-md-12'><div class=''><input name='s_name[]' type='text' placeholder='Enter Specialty Name' class='form-control input-md mt-2'  /></div></div> </td>");
