<div class="content-wrapper">
	<section class="content-header mb-4">
		...
		<ol class="breadcrumb">
			...
			<li class="active"> Doctor Wise Reports</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				...
				<div class=" ">
					<div style="padding:20px;">
						<form id="defaultForm" autocomplete="off" target="_balnk" method="post" class="form-horizontal" action="<?php echo base_url('reports/doctorprints'); ?>">
							<div class=" row ">
