        ...
        <tbody>
			<?php if(isset($p_list) && count($p_list)>0){ ?>
			   <?php foreach($p_list as $li){ ?>
				<tr>
					<th><?php echo isset($li['o_p_id'])?$li['o_p_id']:''; ?></th>
					...
					<th><?php echo isset($li['dname'])?$li['dname']:''; ?></th>
					<th><?php echo isset($li['c_fee'])?$li['c_fee']:''; ?></th>
					<th><?php echo isset($li['c_fee'])?$li['c_fee']:''; ?></th>
					<th><a href="<?php echo base_url('patient/opview/'.base64_encode($li['o_p_id'])); ?>">View</a></th>
